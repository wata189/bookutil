...
const links: Link[] = [
  ...
  },
  {
    ...
    searchUrl: {
      isbn: null,
      bookName:
        "https://bookwalker.jp/search/?qcat=&word=" + SEARCH_PLACEHOLDER,
      authorName: null,
    },
  },
  {
    ...
    searchUrl: {
      ...
      bookName:
        "https://www.amazon.co.jp/s?k=" + SEARCH_PLACEHOLDER + "&i=stripbooks",
      authorName: null,
    },
  },
  {
  ...
  },
  {
    ...
    searchUrl: {
      isbn:
        "https://ndlsearch.ndl.go.jp/search?cs=bib&display=panel&from=0&size=20&f-ht=ndl&f-mt=dtbook&f-mt=magazine&f-mt=dissertation&f-mt=dbook&f-mt=ddoc&f-isbn=" +
        SEARCH_PLACEHOLDER,
      bookName:
        "https://ndlsearch.ndl.go.jp/search?cs=bib&display=panel&from=0&size=20&keyword=" +
        SEARCH_PLACEHOLDER +
        "&f-ht=ndl&f-mt=dtbook&f-mt=magazine&f-mt=dissertation&f-mt=dbook&f-mt=ddoc",
      authorName: null,
    },
  },
  {
    title: "Audible",
    imgUrl: "img/audible.jpg",
    searchUrl: {
      isbn: null,
      bookName:
        "https://www.audible.co.jp/search?keywords=" + SEARCH_PLACEHOLDER,
      authorName: null,
    },
  },
  {
    ...
    searchUrl: {
      isbn:
        "https://wata189.github.io/multisearch-vite/?isbn=" +
        SEARCH_PLACEHOLDER,
      bookName:
        "https://wata189.github.io/multisearch-vite/?bookName=" +
        SEARCH_PLACEHOLDER,
      authorName: null,
    },
  },
...
const linkBtns: ComputedRef<LinkBtn[]> = computed(() => {
  const linkBtns: LinkBtn[] = links.map((link) => {
    ...
    if (props.isbn && link.searchUrl.isbn) {
      ...
      href = link.searchUrl.bookName.replace(
        SEARCH_PLACEHOLDER,
        props.bookName,
      );
      ...
      const trimedAuthorName = props.authorName
        .trim()
        // eslint-disable-next-line no-irregular-whitespace
        .replace(/[ 　,，、]/g, "");
      href = link.searchUrl.authorName.replace(
        SEARCH_PLACEHOLDER,
        trimedAuthorName,
      );
    }
