    ...
    <q-page>
      <div class="row justify-center">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
          <div
            v-for="library in dispLibraries"
            :key="library.id"
            class="q-pa-md"
          >
            <q-card class="q-pa-md" :class="util.accentColorClasses.value">
              <div class="text-h6">{{ library.city }}図書館</div>
              <div>
                {{ library.name }}
                <span v-if="library.closestStation"
              ...
              <div class="row">
                <c-round-link
                  ...
                  color="primary"
                  :href="
                    util.isSmartPhone() && library.spUrl
                      ? library.spUrl
                      : library.url
                  "
                ></c-round-link>
